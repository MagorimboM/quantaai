...
export function CompanyWorkSpaceCard({
  ...
  // TODO :: onclick navigate to  workspace;
      ...
      <div className="flex flex-col gap-4 w-full border rounded-lg p-4 bg-card text-card-foreground">
        ...
        <div className="flex flex-row justify-between w-full">
          <div className="flex flex-row items-center justify-between w-full cursor-pointer">
            ...
            <div className="flex flex-row items-center gap-2">
              <MdOutlineCalendarMonth size={20} className="text-muted-foreground" />
              <div className="flex flex-col items-start gap-0.5">
        ...
        <button className="w-full rounded-md p-2 text-sm font-medium border-2 border-primary text-primary transition-all duration-300 ease-in-out hover:bg-primary hover:text-primary-foreground active:scale-95 cursor-pointer">
          Enter Workspace
        </button>
      </div>
    </>
